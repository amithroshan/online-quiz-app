                    ...
                    <div class="flex flex-wrap"> 
                        <div class="w-full px-4 lg:w-1/2">
                            <div class="p-5 bg-white rounded-lg shadow-lg">
                                ...
                                <input type="submit" name="submit1" value="Update Exam" class="px-4 py-2 font-bold text-white bg-green-500 rounded hover:bg-green-700 focus:outline-none focus:shadow-outline">
                            </div>
                        </div>
